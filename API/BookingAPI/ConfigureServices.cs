...
public static class ConfigureServices
{
    public static IServiceCollection AddAPIServices(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        {
            builder.WithOrigins("http://localhost:5173", "https://gentle-forest-0a8d7bb03.6.azurestaticapps.net", "https://booking.mbogdan.pl", "https://app.mbogdan.pl", "https://booking-app.mbogdan.pl")
                   .AllowAnyMethod()
                   .AllowAnyHeader()
                   .AllowCredentials()
